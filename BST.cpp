...
template <typename T>
BSTNode<T> * BSTree<T>::search(T key) { return search(_Root, key); }
...
template<typename T>
void BSTree<T>::preOrder() { preOrder(_Root); }
template<typename T>
...
template<typename T>
BSTNode<T>* BSTree<T>::minimumNode() { return minimumNode(_Root); }
...
template<typename T>
BSTNode<T>* BSTree<T>::maximumNode() { return maximumNode(_Root); }
...
template<typename T>
void BSTree<T>::print() { print(_Root); }
...
template<typename T>
void BSTree<T>::destory() { destory(_Root); }
